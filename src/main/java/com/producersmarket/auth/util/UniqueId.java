package com.producersmarket.auth.util;
...
public class UniqueId {
    ...
    public static synchronized String getUniqueId() {
        ...
        /*
        return StringUtils.pad(timestamp, pad, padLength, padDirection)
            + StringUtils.pad(threadHashCode, pad, padLength, padDirection)
            + StringUtils.pad(randomInt, pad, padLength, padDirection)
            + StringUtils.pad(mathRandom, pad, padLength, padDirection)
        ;
        */
        return sb.toString();
